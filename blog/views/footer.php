...
<div id="avisoLegal" class = "container mt-3 fw-light fst-italic fs-6">
    ...
    los Titulares, expone sus datos identificativos.
    /(No procede registro mercantil/)
    NIF: 00000000L, Domicilio: Foap 2023: Aula UPC</p>
    <p class="aviso bg-secondary text-white">La <strong>finalidad </strong>del sitio Web es de ejercicio práctico de PHP .</p>
</div>
</footer>