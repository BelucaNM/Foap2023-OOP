...
require "../includes/reservasLista-inc.php";
?>
...
<div class="container mt-3">
    <h2>Pisos</h2>
    <div class="float-end">
        <a href="../includes/generatePdfReservas.php"><button class="btn btn-primary">Generate PDF</button></a> </div>
...
<?php
            ...
            foreach ($todos as $key => $reserva) {
                echo "<tr>";
                echo "<td>$reserva[idReservas]</td>";
                echo "<td>$reserva[fechaSolicitud]</td>";
                echo "<td>$reserva[pisos_idPis]</td>";
               echo "</tr>";
            };
    ?>
</tbody>
